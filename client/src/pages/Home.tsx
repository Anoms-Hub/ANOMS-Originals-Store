...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <section id="services" className="py-20 border-t border-border">
        <div className="container">
          <div className="mb-16 text-center">
            <h2 className="font-display text-4xl mb-4 glow-cyan">SERVICES</h2>
      ...
      <section id="portfolio" className="py-20 border-t border-border bg-card/30">
        <div className="container">
          <div className="mb-16 text-center">
            <h2 className="font-display text-4xl mb-4 glow-magenta">COMMUNITY LOVE</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
        ...
        <div className="container">
          <div className="max-w-2xl mx-auto">
            <div className="mb-12 text-center">
              <h2 className="font-display text-4xl mb-4 glow-cyan">LET'S COLLABORATE</h2>
              <p className="text-muted-foreground">
                Have a project in mind? Reach out and let's create something amazing together.
              </p>
            </div>

            <Card className="bg-card border-border p-8 neon-border">
